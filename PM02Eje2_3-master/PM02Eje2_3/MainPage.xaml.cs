    ...
    public partial class MainPage : ContentPage
    {
        ...
        private async void B_Grabar_Clicked(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtdescripcion.Text))
            {
                ...
                await DisplayAlert("HOLA", "La Descripción esta vacia!", "SI");
                return;
            }
        ...
        private async void B_Pausa_Clicked(object sender, EventArgs e)
        {
            ...
            if (audioRecorderService.IsRecording)
            {
                ...
                if (await DisplayAlert("Lista", "Reproducir Audio", "Si", "No"))
                {
                    audioPlayer.Play(audioRecorderService.GetAudioFilePath());
                }
        ...
        private async void Guardar()
        {
            ...
            if (record == 1)
            {
                await DisplayAlert("", "Audio" + audios.descripcion + "Guardado" + audios.url, "SI");
                txtdescripcion.Text = "";
            }
            else
            {
                await DisplayAlert("HOLA", "No se guardó", "SI");
            }
        }
    }
}
